...
class Pedido extends Model
{
    public function produtos() {
        ...
        /*
            1 - Modelo do relacionamento NxN em relação ao Modelo que estou implementando
            ...
            4 - Representa o nome da FK da tabela mapeada pelo model utilizado no relacionamento que estou implementando
        */
